---
title: "Do Foreigners Have to Pay Taxes in Korea?"
...
audience: ["Foreign employees starting work in Korea", "Freelancers receiving Korean-source income", "Students with part-time jobs", "Long-term residents comparing tax residency and visa document needs"]
keyPoints: ["Tax duty depends on facts, not only nationality.", "Salary employees and freelancers usually follow different tax workflows.", "Tax residency can affect how Korean and foreign income are reviewed.", "Official Hometax or National Tax Service guidance should be checked before filing decisions."]
documents: ["Alien registration or foreigner registration information", "Income statements or payslips", "Withholding receipts", "Hometax login or certificate access", "Documents requested by employer, school, bank, or immigration office"]
mistakes: ["Assuming a foreign passport means no Korean tax duty", "Assuming year-end settlement covers every income source", "Ignoring freelance income because tax was already withheld", "Waiting until a visa deadline to look for tax documents"]
related:
...
faqs:
  - { question: "Do all foreigners in Korea pay tax?", answer: "Not all foreigners have the same tax situation. Tax may depend on income source, residency, work type, and treaty rules." }
...
For next steps, read the [Korea Income Tax Filing Guide for Foreigners](/guides/korea-income-tax-filing-foreigners/), then use the [Do I Need to File Tax in Korea?](/tools/do-i-need-to-file-tax/) checklist for a general direction.
